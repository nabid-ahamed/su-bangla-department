...
import { Home, Search, ArrowLeft, BookOpen, Feather } from 'lucide-react';
import Container from '@/components/ui/Container';

export const metadata = {
  title: 'Page Not Found',
  description:
    "The page you're looking for doesn't exist on the Department of Bangla website.",
};
...
export default function NotFound() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden pt-[180px] md:pt-[200px] pb-20 bg-gray-50">
      ...
      {/* Decorative marks — an open book and a quill, matching the
          department's literary identity (previously engineering cogs). */}
      <BookOpen
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-primary mb-4">
            Looks like this page is missing from our shelves.
          </h2>
