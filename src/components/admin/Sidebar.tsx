...
const ABOUT_PAGES_NAV: NavItem[] = [
  ...
  { href: '/admin/department-layout',     label: 'Department Layout', icon: Info },
  { href: '/admin/cultural-club',      label: 'Cultural Club',    icon: Info },
];
    ...
    <>
      ...
      <div className="px-6 pt-14 pb-5 border-b border-gray-100 lg:pt-5">
        ...
        <div className="text-base font-display font-bold text-primary mt-1 leading-tight">
          {/* The CMS stores the full name ("Department of Bangla"); the
              "Dept. of" overline above already carries the prefix, so
              strip it to avoid rendering it twice. */}
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        {/* Club join applications — operational inbox, mirrors the
            Contact Submissions placement (no badge wired yet). The
            route keeps its original slug; only the label changed when
